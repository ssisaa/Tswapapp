    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
        ...
        <Card className="bg-dark-200 border-dark-400 p-6">
          ...
          <div className="grid grid-cols-3 gap-2">
            <Link href="/swap" className="bg-blue-600 text-white text-center py-2 px-4 rounded font-medium hover:bg-blue-700 transition">
              Buy
            </Link>
            <Link href="/swap" className="bg-dark-300 text-white text-center py-2 px-4 rounded font-medium hover:bg-dark-400 transition">
              Sell
            </Link>
            <Link href="/stake" className="bg-dark-300 text-white text-center py-2 px-4 rounded font-medium hover:bg-dark-400 transition">
              Stake
            </Link>
          </div>
        </Card>
        ...
        <Card className="bg-dark-200 border-dark-400 p-6">
          ...
          <div className="grid grid-cols-2 gap-2">
            <Link href="/swap" className="flex items-center justify-center bg-green-600 text-white py-2 px-4 rounded font-medium hover:bg-green-700 transition">
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <Card className="bg-dark-200 border-dark-400 p-4">
            <h3 className="text-gray-400 text-sm">Total YOS Harvested</h3>
            <div className="text-xl font-semibold text-white mt-1">
              {stakingLoading ? "Loading..." : formatNumber(globalStats ? globalStats.totalHarvested : 0)}
              <span className="text-green-400 text-sm ml-1">YOS</span>
            </div>
          </Card>
          
          <Card className="bg-dark-200 border-dark-400 p-4">
            <h3 className="text-gray-400 text-sm">YOS Rewards Value</h3>
            <div className="text-xl font-semibold text-white mt-1">
              ${stakingLoading ? "Loading..." : formatCurrency((globalStats ? globalStats.totalHarvested : 0) * priceData.yosPrice)}
            </div>
          </Card>
        </div>
      </div>
      ...
      {/* Your Staking Status */}
      {connected && stakingInfo && (
        <Card className="bg-dark-200 border-dark-400 p-6 mb-8">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-semibold text-white">Your Staking Status</h2>
            <Button variant="outline" className="bg-dark-300 border-dark-400 hover:bg-dark-400">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-dark-300 rounded-lg p-4 border border-dark-400">
              <h3 className="text-gray-400 text-sm mb-2">YOT Staked</h3>
              <div className="text-2xl font-semibold text-white">
                {formatNumber(stakingInfo.staked)} YOT
              </div>
              <div className="text-xs text-gray-500 mt-1">
                Value: ${formatCurrency(stakingInfo.staked * priceData.yotPrice)}
              </div>
            </div>
            <div className="bg-dark-300 rounded-lg p-4 border border-dark-400">
              <h3 className="text-gray-400 text-sm mb-2">Pending Rewards</h3>
              <div className="text-2xl font-semibold text-green-400">
                {formatNumber(stakingInfo.pendingRewards)} YOS
              </div>
              <div className="text-xs text-gray-500 mt-1">
                Value: ${formatCurrency(stakingInfo.pendingRewards * priceData.yosPrice)}
              </div>
            </div>
            <div className="bg-dark-300 rounded-lg p-4 border border-dark-400">
              <h3 className="text-gray-400 text-sm mb-2">Harvested Rewards</h3>
              <div className="text-2xl font-semibold text-white">
                {formatNumber(stakingInfo.harvested)} YOS
              </div>
              <div className="text-xs text-gray-500 mt-1">
                Value: ${formatCurrency(stakingInfo.harvested * priceData.yosPrice)}
              </div>
            </div>
          </div>
        </Card>
